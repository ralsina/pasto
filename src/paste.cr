...
module Pasto
  ...
  module MimeTypes
    ...
    MIME_TYPES = {
      ...
      "composer"      => "text/x-json",
      "packagelock"   => "text/x-json",
      "npm"           => "text/x-json",
      "requirements"  => "text/x-requirements",
      "pipfile"       => "text/x-toml",
      "pipfilelock"   => "text/x-toml",
      "poetry"        => "text/x-toml",
      "cargo"         => "text/x-toml",
      "cartfile"      => "text/x-json",
      "podspec"       => "text/x-ruby",
      "gemfile"       => "text/x-ruby",
      "gemspec"       => "text/x-ruby",
      "rakefile"      => "text/x-ruby",
      "procfile"      => "text/x-shellscript",
      "heroku"        => "text/x-shellscript",
      "vercel"        => "text/x-json",
      "netlify"       => "text/x-yaml",
      "github"        => "text/x-yaml",
      "gitlab"        => "text/x-yaml",
      "jenkins"       => "text-x-groovy",
      "docker"        => "text/x-dockerfile",
    ...
    def self.get_mime_type(language : String?) : String
      return "text/plain; charset=utf-8" if language.nil? || language.empty?

      lang_key = language.downcase
      MIME_TYPES[lang_key]? || "text/plain; charset=utf-8"
    end
