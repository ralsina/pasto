...
module Pasto
  ...
  def self.register_api_routes
    base_path = Pasto.config.base_path

    # API documentation page
    get Pasto::PathHelper.with_base_path("/api-docs", base_path) do |env|
      env.redirect "#{base_path}/assets/api-docs.html"
    end

    # Dynamic OpenAPI specification
    get Pasto::PathHelper.with_base_path("/openapi.yaml", base_path) do |env|
    ...
    get Pasto::PathHelper.with_base_path("/api/languages", base_path) do |env|
    ...
    get Pasto::PathHelper.with_base_path("/api/themes", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    get Pasto::PathHelper.with_base_path("/api/qr/:id", base_path) do |env|
    ...
    get Pasto::PathHelper.with_base_path("/api/v1/me", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    get Pasto::PathHelper.with_base_path("/api/v1/pastes", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    post Pasto::PathHelper.with_base_path("/api/v1/pastes", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    get Pasto::PathHelper.with_base_path("/api/v1/pastes/:id", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    get Pasto::PathHelper.with_base_path("/api/v1/pastes/:id/content", base_path) do |env|
    ...
    patch Pasto::PathHelper.with_base_path("/api/v1/pastes/:id", base_path) do |env|
      env.response.content_type = "application/json"
    ...
    delete Pasto::PathHelper.with_base_path("/api/v1/pastes/:id", base_path) do |env|
      env.response.content_type = "application/json"
